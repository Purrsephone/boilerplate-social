...
const posts = [
  ...
  },
  {
    ...
    profilePic: require("./Profile.png"),
    content:
      "The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold... The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold...The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold... The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold...The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold... The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold...The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold... The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold...The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold... The city has its own charm as the sun sets. The skyline against the orange glow is a sight to behold...",
...
const PostBlock = ({ post }) => {
  ...
  // Inside your PostBlock component
  const savePost = () => {
  ...
  return (
    <View style={styles.postContainer}>
      ...
      <View style={styles.categoryIconContainer}>
        ...
        <MaterialCommunityIcons name="gavel" size={20} color="white" />
      ...
      <View style={styles.saveReportContainer}>
        ...
        <TouchableOpacity onPress={reportPost} style={styles.reportButton}>
          <SimpleLineIcons name="exclamation" size={20} color="white" />
        </TouchableOpacity>
      </View>

      <View style={styles.footerContainer}>
        <TouchableOpacity style={styles.statButton} onPress={claimAnalysis}>
          <Text style={styles.statText}>Claim Analysis</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  reportButton: {
    marginLeft: 10, // Adjust spacing between save and report buttons
  },
  ...
  categoryIconContainer: {
    ...
    left: 0,
    right: 0,
    bottom: 0, // Position at the bottom of the grey panel
    height: 35, // Adjust as necessary
    backgroundColor: "#716d76", // Match with the footerContainer background color
  },
});
