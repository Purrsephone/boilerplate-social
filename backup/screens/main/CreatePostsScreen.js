...
const CreatePostsScreen = ({ navigation }) => {
  ...
  const CameraPermission = () => {
    return Alert.alert(
      '"Social App" Would Like to Access the Camera',
          ...
          <View style={styles.innerBox} height={60}>
            {isOpenCamera === false ? (
              <ImageBackground
                style={
                  !photo
                    ? [styles.postImg]
                    : { ...styles.takePhotoContainer, borderRadius: 8 }
                }
                source={{ uri: photo }}
              >
                <TouchableOpacity
                  style={
                    photo
                      ? { ...styles.postImgAdd, backgroundColor: "#FFFFFF4D" }
                      : [styles.postImgAdd]
                  }
                  onPress={openCamera}
                >
            ...
            <View style={styles.postForm}>
              <TextInput
                style={
                  isFocused.title
                    ? { ...styles.input, borderBottomColor: "#FF6C00" }
              ...
              <View style={{ position: "relative" }}>
                <TextInput
                  style={
                    isFocused.place
                      ...
                      : { ...styles.input, marginTop: 32, paddingLeft: 24 }
                  }
                ...
                <View style={styles.inputIcon}>
                  <Feather
                    ...
                    size={16}
                    color="#BDBDBD"
                    style={isFocused.place && { color: "#FF6C00" }}
                  />
                </View>
              </View>

              {(photo !== null && title.length >= 1) ||
              (location.length >= 1 && inputLocation.length >= 1) ? (
                <TouchableOpacity
